  ...
  main.variable(observer("geojson")).define("geojson", ["L","info","map","bairros","style"], function(L,info,map,bairros,style)
{
  ...
  main.variable(observer("legend")).define("legend", ["L","red","colorScale","d3","map"], function(L,red,colorScale,d3,map)
{
...
<main role="main" class="container">
 ...
 `
  ...
  main.variable(observer("red")).define("red", ["d3"], function(d3){return(
d3.schemeReds[9]
)});
  main.variable(observer("colorScale")).define("colorScale", ["d3","red"], function(d3,red){return(
d3.scaleQuantize()
    .domain([0, 425.13])
    .range(red)
)});
