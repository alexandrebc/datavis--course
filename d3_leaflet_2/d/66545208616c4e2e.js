...
integrity="sha512-xwE/Az9zrjBIphAcBb3F6JVqxf46+CDLwfLMHloNu6KEQCAWi6HcDUbeOfBIptF7tcCzusKFjFw2yuvEpDL9wQ==" crossorigin=""/>`
  ...
  main.variable(observer("buildvis")).define("buildvis", ["md","container","dc","d3","typeCrimeDimension","typeCrimeGroup","colorScale","dayDimension","dayGroup","dataset"], function(md,container,dc,d3,typeCrimeDimension,typeCrimeGroup,colorScale,dayDimension,dayGroup,dataset)
{
...
crossfilter(dataset)
  ...
  main.variable(observer("typeCrimeDimension")).define("typeCrimeDimension", ["facts"], function(facts){return(
facts.dimension(d => d.crimeType)
)});
  main.variable(observer("typeCrimeGroup")).define("typeCrimeGroup", ["typeCrimeDimension"], function(typeCrimeDimension){return(
typeCrimeDimension.group()
)});
